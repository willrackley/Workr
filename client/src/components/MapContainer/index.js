...
export class MapContainer extends React.Component {
    ...
    componentDidMount(props){
        ...
        this.handleChange=(updatedLatitude, updatedLongitude) => {
            const API_URL ='https://us1.locationiq.com/v1/reverse.php?key=69b410ea8cf9cb&lat=' +updatedLatitude+ '&lon=' +updatedLongitude+'&format=json';
       ...
       //             console.log('Users zipcode ' , response.address.postcode);
       //             var zipCode=JSON.parse(response.address.postcode);
       //             console.log('Yay! Zipcode has been added: ' +zipCode);
       //             // zipcodeRadius(zipCode);
       //  })
